...
OMC_DISABLE_OPT
int DutMonitor_updateBoundVariableAttributes(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  /* min ******************************************************** */
...
void DutMonitor_updateBoundParameters_0(DATA *data, threadData_t *threadData);
extern void DutMonitor_eqFunction_1(DATA *data, threadData_t *threadData);
...
*/
OMC_DISABLE_OPT
static void DutMonitor_eqFunction_26(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
OMC_DISABLE_OPT
static void DutMonitor_eqFunction_27(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(!tmp10)
  {
    tmp6 = GreaterEq((data->simulationInfo->realParameter[2]/* dut_turbine.J PARAM */) ,0.0);
    if(!tmp6)
    {
      tmp8 = modelica_real_to_modelica_string_format((data->simulationInfo->realParameter[2]/* dut_turbine.J PARAM */) , (modelica_string) mmc_strings_len1[103]);
...
void DutMonitor_updateBoundParameters_0(DATA *data, threadData_t *threadData)
{
  ...
  DutMonitor_eqFunction_26(data, threadData);
  DutMonitor_eqFunction_27(data, threadData);
  TRACE_POP
}
OMC_DISABLE_OPT
int DutMonitor_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  (data->simulationInfo->integerParameter[3]/* dut_turbine.stateSelect PARAM */)  = 5;
  data->modelData->integerParameterData[3].time_unvarying = 1;
  DutMonitor_updateBoundParameters_0(data, threadData);
  TRACE_POP
  return 0;
}
